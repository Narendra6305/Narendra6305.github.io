/* -------------------------------------------------------------
 *  PORTFOLIO INTERACTIVITY & ANIMATION LOGIC
...
/* 1. DYNAMIC DATA PARTICLE CANVAS */
...
/* 6. INTERACTIVE ANALYTICS LAB TAB SWITCHING & SIMULATORS */
...
// Churn Probability Calculator Logic
function updateChurnSim() {
  ...
  // Formula simulated based on logistic model coefficients
  let baseScore = 0.5;
...
// Heart Disease Risk Calculator Logic
function updateHeartSim() {
  ...
  // Simulated Random Forest + SVM Risk Index
  let riskScore = 10;
...
/* 7. ALGORITHM BENCHMARK CHART (CHART.JS) */
...
/* 8. 3D GYROSCOPE TILT EFFECT FOR CARDS */
...
/* 9. MODAL POPUP LOGIC FOR PROJECT DETAILS */
...
/* 10. CONTACT FORM SUBMISSION FEEDBACK */
